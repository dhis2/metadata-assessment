...
pacman::p_load(jsonlite, httr, purrr,knitr,magrittr,ggplot2,DT,dplyr,yaml,knitr,rmarkdown,dplyr)
...
results<-purrr::map_dfr(views$summary_uid,function(x) getSQLView(x,d2_session = d2_session)) %>% 
  dplyr::left_join(views[,c("summary_uid","section","section_order")] , by =c("uid"="summary_uid")) %>% 
